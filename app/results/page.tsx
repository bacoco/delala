        ...
        <div className="flex">
          ...
          <div>
            ...
            <p className="text-sm text-amber-700 mt-1">
              Ces horaires sont <strong>fictifs</strong>. Pour obtenir de vrais horaires SNCF, configurez une clé API (voir .env.example)
            </p>
            <div className="mt-2 text-sm text-amber-700">
              Options d'API disponibles:
              <ul className="list-disc list-inside mt-1">
                <li><a href="https://numerique.sncf.com/startup/api/" target="_blank" rel="noopener noreferrer" className="underline">API SNCF officielle</a></li>
                <li><a href="https://www.navitia.io/" target="_blank" rel="noopener noreferrer" className="underline">Navitia.io (recommandé)</a></li>
                <li><a href="https://ressources.data.sncf.com/" target="_blank" rel="noopener noreferrer" className="underline">Open Data SNCF</a></li>
              </ul>
            </div>
          </div>
        </div>
